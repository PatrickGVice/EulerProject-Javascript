...
//The 1000 digit number into an array
var numArr = [7,3,1,6,7,1,7,6,5,3,1,3,3,0,6,2,4,9,1,9,2,2,5,1,1,
...
var fiveNumProduct = function (){
  var result = 0;
  var num = 0;

  for (var i=0; i < numArr.length-4; i++){
    num = numArr[i] * numArr[i+1] * numArr[i+2] *
